...
codes = [{"code":"B49..00","system":"readv2"},{"code":"B4z..00","system":"readv2"},{"code":"B4...11","system":"readv2"},{"code":"Byu9.00","system":"readv2"},{"code":"B4Ay000","system":"readv2"},{"code":"B494.00","system":"readv2"},{"code":"B4y..00","system":"readv2"},{"code":"B490.00","system":"readv2"},{"code":"B492.00","system":"readv2"},{"code":"B4Az.00","system":"readv2"},{"code":"B4...00","system":"readv2"},{"code":"B493.00","system":"readv2"},{"code":"B49z.00","system":"readv2"}];
REQUIRED_CODES = 1;
